...
cd /d "%~dp0"
echo Flashing DomOS firmware to COM5...
"C:\Espressif\python_env\idf5.3_py3.11_env\Scripts\python.exe" "C:\Espressif\frameworks\esp-idf-v5.3.1\tools\idf.py" -p COM5 -b 460800 flash monitor
