...
cd /d "d:\Work space\DomOS\firmware"
if exist build ( rmdir /s /q build )
"C:\Espressif\python_env\idf5.3_py3.11_env\Scripts\python.exe" "C:\Espressif\frameworks\esp-idf-v5.3.1\tools\idf.py" -p COM5 set-target esp32s3
"C:\Espressif\python_env\idf5.3_py3.11_env\Scripts\python.exe" "C:\Espressif\frameworks\esp-idf-v5.3.1\tools\idf.py" -p COM5 build flash monitor
