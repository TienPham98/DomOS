...
import { Palette, Check, Paintbrush, Type, Square, Sun, Moon, Clock, SlidersHorizontal, Eye } from "lucide-react";
...
export default function ThemesPage() {
  ...
  const syncToDevice = async (style = selectedClockStyle, color = primaryColor, currentMode = mode) => {
    ...
    try {
      ...
      setStatusMsg(`Device Sync Error (${targetHost}): ${err.message}`);
