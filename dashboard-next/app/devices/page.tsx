...
import { PageHeader, StatusBadge, StorageBar, Section } from "@/components/dashboard-primitives";
...
export default function DevicesPage() {
  const { board, deviceList, error } = useBoard();
      ...
      <div className="grid gap-6">
        {devices.length === 0 ? (
          <div className="dom-card p-12 text-center text-slate-500 text-sm">
            {error ? `Connection error: ${error}` : "Searching for ES3C28P board at http://192.168.0.106..."}
          </div>
        ) : (
