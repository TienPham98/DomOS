...
import { Upload, Shield, Download, RotateCcw, CheckCircle2, AlertTriangle, Clock } from "lucide-react";
import { PageHeader, Section, EmptyState } from "@/components/dashboard-primitives";
...
export default function OtaPage() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const deviceIp = typeof window !== "undefined" ? localStorage.getItem("domos_device_ip") || "192.168.0.106" : "192.168.0.106";
